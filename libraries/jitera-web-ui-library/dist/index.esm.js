import { jsx as aT, jsxs as aU } from "react/jsx-runtime";
import a, {
  useMemo as aV,
  useState as aW,
  Children as aX,
...
import * as be from "react-icons/ai";
import * as bf from "react-icons/bs";
import * as bg from "react-icons/fa";
import * as bh from "react-icons/fi";
import * as bi from "react-icons/md";
import b from "styled-components";
import bj, { Content as bk, Header as bl } from "antd/lib/layout/layout";
import bm from "antd/lib/menu/SubMenu";
import bn from "antd/lib/layout/Sider";
import bo, { components as bp } from "react-select";
import bq from "dayjs";
import o from "rc-picker/lib/generate/dayjs";
import p from "antd/lib/date-picker/generatePicker";
import br from "react-slick";
import { render as bs } from "rc-util/lib/React/render";
...
import b0 from "react-otp-input";
function b1({ className: b = "", responsiveVisibility: a = [] }) {
  return {
    classNames: a1(
      b,
      3 === a.length
...
let F = a.forwardRef((a, b) => {
  let { children: c, responsiveVisibility: d, className: e, ...f } = a,
    { classNames: g } = b1({ className: e, responsiveVisibility: d });
  return aT("div", { ...f, className: g, ref: b, children: c });
});
function G(b, c = {}) {
  return a.createElement(
    b in be ? be[b] : b in bf ? bf[b] : b in bh ? bh[b] : b in bg ? bg[b] : b in bi ? bi[b] : "",
    c
  );
}
function H(a) {
...
let J = a.forwardRef((a, b) => {
    let { className: c, style: d, iconName: e, color: f, size: g, responsiveVisibility: h } = a,
      { classNames: i } = b1({ className: c, responsiveVisibility: h });
    return aT("span", {
...
`,
  K = a.forwardRef((b, c) => {
    let {
      ...
      { classNames: j } = b1({ className: g, responsiveVisibility: e });
    return aT(a2, {
      type: d,
      icon: a,
      ...i,
      className: j,
      ref: c,
      children: aT(b2, { hasIcon: !!a, children: h }),
    });
  }),
  L = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
    return aT(a3, { ...f, className: g, ref: b, children: c });
  }),
  M = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
    return aT(bk, { ...f, className: g, prefixCls: "jitera-layout-content", ref: b, children: c });
  }),
  N = a.forwardRef((a, b) => {
    let { children: c, style: d, responsiveVisibility: e, className: f, ...g } = a,
      { classNames: h } = b1({ className: f, responsiveVisibility: e });
    return aT("footer", { ...g, className: h, style: d, ref: b, children: c });
  }),
  O = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
  ...
  Q = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
    return aT(bl, { ...f, prefixCls: "jitera-layout-header", className: g, ref: b, children: c });
  }),
  R = a.forwardRef((a, b) => {
    let { source: c, alt: d = "", responsiveVisibility: e, className: f, ...g } = a,
      { classNames: h } = b1({ className: f, responsiveVisibility: e });
    return aT("img", { ref: b, src: c, className: h, ...g, alt: d });
  });
!(function (a) {
  (a.Link = "Link"),
    (a.Text = "Text"),
...
let S = a.forwardRef(({ children: a, ...b }, c) => aT("div", { ...b, ref: c, children: a })),
  T = a.forwardRef(({ children: a, ...b }, c) => aT("a", { ...b, ref: c, children: a })),
  U = a.forwardRef(({ children: a, ...b }, c) => aT("h1", { ...b, ref: c, children: a })),
  V = a.forwardRef(({ children: a, ...b }, c) => aT("h2", { ...b, ref: c, children: a })),
  W = a.forwardRef(({ children: a, ...b }, c) => aT("h3", { ...b, ref: c, children: a })),
  X = a.forwardRef(({ children: a, ...b }, c) => aT("h4", { ...b, ref: c, children: a })),
  Y = a.forwardRef(({ children: a, ...b }, c) => aT("h5", { ...b, ref: c, children: a })),
  Z = a.forwardRef(({ children: a, ...b }, c) => aT("h6", { ...b, ref: c, children: a })),
  $ = a.forwardRef(({ children: a, ...b }, c) => aT("b", { ...b, ref: c, children: a })),
  _ = a.forwardRef(({ children: a, ...b }, c) => aT("i", { ...b, ref: c, children: a })),
  aa = a.forwardRef(({ children: a, ...b }, c) => aT("em", { ...b, ref: c, children: a })),
  ab = a.forwardRef(({ children: a, ...b }, c) => aT("u", { ...b, ref: c, children: a })),
  ac = a.forwardRef(({ children: a, ...b }, c) => aT("s", { ...b, ref: c, children: a })),
  ad = a.forwardRef(({ children: a, ...b }, c) => aT("del", { ...b, ref: c, children: a })),
  ae = a.forwardRef(({ children: a, ...b }, c) => aT("pre", { ...b, ref: c, children: a })),
  af = a.forwardRef(({ children: a, ...b }, c) => aT("code", { ...b, ref: c, children: a })),
  ag = a.forwardRef(({ children: a, ...b }, c) => aT("blockquote", { ...b, ref: c, children: a })),
  ah = a.forwardRef(({ children: a, ...b }, c) => aT("figcaption", { ...b, ref: c, children: a })),
  ai = a.forwardRef(({ children: a, ...b }, c) => aT("cite", { ...b, ref: c, children: a })),
  b3 = {
    [al.Text]: S,
    [al.Link]: T,
    [al.H1]: U,
  ...
  aj = a.forwardRef((a, b) => {
    let { textType: c = al.Text, responsiveVisibility: d, className: e, ...f } = a,
      g = b3[c],
      { classNames: h } = b1({ className: e, responsiveVisibility: d });
    return aT(g, { ...f, className: h, ref: b });
  }),
  b4 = (a) => "object" == typeof a,
  b5 = (...a) => a.filter((a) => !b4(a)).join(" "),
  b6 = "mccb30e4f2_input";
var ak,
  al,
  c,
  ...
  g,
  h,
  b7 = { input: "mccb30e4f2_input" };
let am = a.forwardRef((c, d) => {
    let {
        style: e = {},
        inputStyle: f = {},
        errorMessage: a,
      ...
      n = aV(
        () => (b4(f) ? { style: f, className: b7.input } : { className: b5(b7.input, f) }),
        [f]
      ),
      o = aV(() => {
        if (j) return aT(J, { ...j });
      ...
      { classNames: q } = b1({ className: b, responsiveVisibility: h });
    return aU("div", {
      style: e,
      className: a1(b5(b7.container, b || ""), q),
      ref: d,
      children: [
        aT(m, { ...n, disabled: i, prefix: o, suffix: p, ...l }),
        !!a && aT(aj, { type: "danger", children: a }),
      ],
    });
  }),
  an = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
    return aT(bj, { ...f, prefixCls: "jitera-layout", className: g, ref: b, children: c });
  }),
  b8 = b.div`
...
`,
  ao = a.forwardRef((b, c) => {
    let { isPreview: a, className: d, responsiveVisibility: e, ...f } = b,
      { classNames: g } = b1({ className: d, responsiveVisibility: e });
    return aT(b8, {
      isPreview: a,
      className: g,
      ref: c,
      children: aT(m, { disabled: a, ...f, prefixCls: "jitera-menu" }),
    });
  });
!(function (a) {
...
let { Item: cd } = m,
  ap = a.forwardRef(
    (
      ...
      let { classNames: i } = b1({ className: f, responsiveVisibility: e });
      return aT(b9, {
        className: i,
        ref: h,
        children: aT(ca, {
          children: aT(cd, { ...g, children: b && c && d ? ce(b, c, d, a) : a }),
        }),
      });
    }
  );
function ce(a, e, b, d) {
  switch (e) {
    case c.Left:
      return aU(cb, { style: { gap: b }, children: [aT(J, { ...a }), d] });
    case c.Right:
      return aU(cb, { style: { gap: b }, children: [d, aT(J, { ...a })] });
    case c.Top:
      return aU(cc, { style: { gap: b }, children: [aT(J, { ...a }), d] });
    case c.Bottom:
      return aU(cc, { style: { gap: b }, children: [d, aT(J, { ...a })] });
    default:
      return H(e);
  }
}
let aq = a.forwardRef((a, b) => aT("ul", { ref: b, children: aT(bm, { ...a }) })),
  cf = b.div`
  width: 100%;
...
`,
  ar = a.forwardRef(({ ...b }, c) => {
    let { children: d, isPreview: a, responsiveVisibility: e, className: f, ...g } = b,
      h = a ? "100%" : "100vh",
      { classNames: i } = b1({ className: f, responsiveVisibility: e });
    return aT(cf, {
  ...
  as = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
    return aT(a5, { ...f, className: g, ref: b, children: c });
  }),
  at = a.forwardRef((a, b) => {
    let { children: c, responsiveVisibility: d, className: e, ...f } = a,
      { classNames: g } = b1({ className: e, responsiveVisibility: d });
    return aT(bn, { ...f, className: g, prefixCls: "jitera-layout-sider", ref: b, children: c });
  }),
  au = a.forwardRef((a, b) => {
    let {
        isPreview: c,
      ...
      o = aV(() => {
        if (l)
          return {
            DropdownIndicator: (a) => aT(bp.DropdownIndicator, { ...a, children: aT(J, { ...l }) }),
          };
      }, [l]),
      { classNames: p } = b1({ className: e, responsiveVisibility: d });
    return aT(bo, {
      className: p,
      components: o,
      isDisabled: c,
...
let av = a.forwardRef((a, b) => {
  ...
  return aT("div", {
    ...
    className: g,
    ref: b,
    children: aT(a6, { className: ch.inner, ...f }),
  });
});
function ci(a) {
...
`,
  aw = a.forwardRef((b, c) => {
    let {
      ...
      o = aV(() => ({ ...d, wrap: ci(m) }), [m, d]),
      p = aV(() => (b4(l) ? { style: l } : { className: b5(l) }), [l]),
      { classNames: q } = b1({ className: g, responsiveVisibility: f });
    return aT(cj, {
      className: q,
      activeColor: h,
      inactiveColor: i,
      ...
      children: aT(a7.Group, {
        ...
        children: aT(a8, {
          ...
          children:
            null == a
              ? void 0
              : a.map((a) => aT(a7, { value: a.value, ...a, children: a.label }, a.value)),
        }),
      }),
    });
  }),
...
let ax = a.forwardRef((c, d) => {
    let {
      ...
      j = aV(
        () => (b4(f) ? { style: f, className: cl.textarea } : { className: b5(cl.textarea, f) }),
        [f]
      ),
      { classNames: k } = b1({ className: b, responsiveVisibility: g });
    return aU("div", {
      style: e,
      className: a1(b5(cl.container, b || ""), k),
      ref: d,
      children: [
        aT(a4.TextArea, { ...j, disabled: h, ...i }),
        !!a && aT(aj, { type: "danger", children: a }),
      ],
    });
  }),
...
`,
  ay = a.forwardRef((b, c) => {
    let {
      ...
      p = aV(() => ({ ...e, wrap: ci(d) }), [d, e]),
      q = aV(() => (b4(h) ? { style: h } : { className: b5(h) }), [h]),
      { classNames: r } = b1({ className: n, responsiveVisibility: g });
    return aT(cm, {
      activeColor: i,
      inactiveColor: j,
      checkColor: k,
      ...
      children: aT(a9.Group, {
        ...
        children: aT(a8, {
          direction: m,
          ...p,
          children: null == a ? void 0 : a.map((a) => aT(a9, { ...a, children: a.label })),
        }),
      }),
    });
  }),
  az = a.forwardRef((b, c) => {
    let {
      ...
      { classNames: i } = b1({ className: g, responsiveVisibility: f });
    return aU("div", {
      className: i,
      ref: c,
      children: [
        aT(ba, { disabled: e, listType: "picture", ...h, children: d }),
        !!a && aT(aj, { type: "danger", children: a }),
      ],
    });
  }),
...
let aA = a.forwardRef((b, c) => {
    let {
      ...
      { classNames: j } = b1({ className: h, responsiveVisibility: f }),
      k = aV(() => ("string" != typeof e && e ? e : bq(e)), [e]);
    return aU("div", {
      className: j,
      ref: c,
      children: [
        aT(cn, { disabled: d, picker: g, defaultValue: k, prefixCls: "jitera-picker", ...i }),
        !!a && aT(aj, { type: "danger", style: { display: "block" }, children: a }),
      ],
    });
  }),
...
let aB = a.forwardRef((a, b) => {
    let {
      ...
      { classNames: w } = b1({ className: m, responsiveVisibility: d });
    return aU("div", {
      className: a1(cp.Wrapper, w),
      ref: b,
      children: [
        aT(K, { onClick: s, style: f, ...e, children: aT(J, { iconName: "MdMenu", ...k }) }),
        aT(n, {
          ...u,
          ...v,
          visible: o,
  ...
  aD = a.forwardRef((b, c) => {
    let {
      ...
      { classNames: s } = b1({ className: r, responsiveVisibility: f }),
      t = aV(() => {
        let b = [];
        return (
          "object" == typeof o &&
      ...
      u = aV(
        () =>
          e && a
            ? e
            : e
            ? aX.map(e, (a) => aT("div", { children: a }))
            : (null == g ? void 0 : g.length) && h
            ? g.map((b, c) => (a ? h(b, c) : aT("div", { children: h(b, c) }, `${b.id}_${c}`)))
            : void 0,
        [e, a, g, h]
      );
    return aT("div", { style: d, className: s, ref: c, children: aT(br, { ...t, children: u }) });
  }),
  cr = b(i)`
  .jitera-tabs-ink-bar {
...
`,
  ...
  aE = a.forwardRef((a, b) => {
    let {
      ...
      { classNames: j } = b1({ className: g, responsiveVisibility: h }),
      k = aV(() => {
        if (f)
          return aX.map(f, (d, a) => {
            let b = (null == e ? void 0 : e[a]) || (null == e ? void 0 : e[`${a}`]),
              c = (null == b ? void 0 : b.title) || `Tab ${a}`;
            return aT(cs, { tab: c, children: d }, (null == b ? void 0 : b.key) || `${c}_${a}`);
          });
      }, [f, e]);
    return aT("div", {
      style: c,
      className: j,
      ref: b,
      children: aT(cr, { type: d, ...i, children: k }),
    });
  }),
  aF = "jitera",
  ct = "jiteraicon",
  ...
  cu = l({ theme: k, toggleTheme(a) {} }),
  aG = () => aY(cu),
  aH = ({ children: a }) => {
    let [b, d] = aW(k),
      e = (b) => {
        let a = { ...k, ...b };
        bb.config({ theme: a, prefixCls: "jitera" }), d(a);
      },
      c = aV(() => ({ theme: b, toggleTheme: e }), [b]);
    return aT(bb, {
      prefixCls: aF,
      iconPrefixCls: "jiteraicon",
      children: aT(cu.Provider, { value: c, children: a }),
    });
  };
!(function (a) {
            ...
            e
              ? setTimeout(() => {
                  ...
                  null === (a = Array.from(b).at(b.length - 1)) ||
                    void 0 === a ||
                    a.classList.add(`jitera-modal-root-${cv.length}`);
                })
              : setTimeout(() => {
                  var a, b;
                  null ===
                    (b =
                      null ===
                        (a = document.querySelector(`.jitera-modal-root-${cv.length + 1}`)) ||
                      void 0 === a
                        ? void 0
                        : a.parentElement) ||
                    void 0 === b ||
...
function cy(a) {
  if (a instanceof HTMLImageElement) {
    let { alt: b, src: c } = a,
      d = cB({ altText: b, src: c });
    return { node: d };
  }
  return null;
}
function cz({ altText: b, className: c, imageRef: d, src: a, width: e, height: f, maxWidth: g }) {
  return (
    cx(a),
    aT("img", {
      className: c || void 0,
...
function cA({ src: e, altText: f, nodeKey: b, width: g, height: h, maxWidth: i }) {
  let j = aZ(null),
    [a, c, k] = bv(b),
    [l] = bu(),
    [d, p] = aW(null),
...
class aJ extends E {
  ...
  static importJSON(d) {
    let { altText: e, height: f, width: g, maxWidth: h, caption: i, src: j, showCaption: k } = d,
      a = cB({ altText: e, height: f, maxWidth: h, showCaption: k, src: j, width: g }),
      b = a.__caption,
  ...
  static importDOM() {
    return { img: () => ({ conversion: cy, priority: 0 }) };
  }
  exportJSON() {
    return {
...
function cB({
  ...
  return new aJ(d, a, c, e, b, f, g, h);
}
function cC(a) {
  return a instanceof aJ;
}
let aK = [z, u, v, A, q, B, C, D, r, s, t, x, aJ, y, w];
var cD = aK;
let aL = {
...
let cF =
  ...
  cG = ({ data: a }) => {
    ...
    return (
      ...
      aT(bF, {
        contentEditable: aT(bG, {}),
        placeholder: aT("div", {}),
        initialEditorState: void 0,
      })
    );
  },
  aM = a.forwardRef(({ style: a, data: b }, c) => {
    let d = {
      editorState: void 0,
    ...
    return aT("div", {
      ref: c,
      style: a,
      children: aT(bt, { initialConfig: d, children: aT(cG, { data: b }) }),
    });
  }),
  cH = b.div`
  && {
...
`,
  ...
  ${(a) => a.customStyle}
`,
  aN = { borderWidth: "1px", borderColor: "#000", borderStyle: "solid" },
  cR = ({
    header: a,
    ...
    return aU(
      cO,
      {
        ...
        children: [
          ...
          h
            ? aT(J, { className: "j-table__thead-th-drag-indicator", iconName: "MdDragIndicator" })
            : void 0,
          d
            ? null !==
                (g = {
                  asc: i ? aT(J, { ...i }) : " \u{1F53C}",
                  desc: j ? aT(J, { ...j }) : " \u{1F53D}",
        ...
        children: [
          c
            ? aT(cP, {
                ...
                ...h,
                ...g,
                children: aT(J, { iconName: "MdDragIndicator" }),
              })
            : void 0,
          a
            .getVisibleCells()
...
let aR = a.forwardRef((g, i) => {
  ...
  b4(b) && b4(a) && (f = { ...b, ...a });
  let { classNames: r } = b1({ className: l, responsiveVisibility: k });
  return aU(cV, {
    className: r,
    ref: i,
    children: [
      aT(b0, {
        ...
        containerStyle: o,
        inputStyle: f,
        className: b5("otp-cell", b, a),
      }),
      !!c && aT(aj, { type: "danger", children: c }),
    ],
  });
});
j.config({ prefixCls: `${aF}-message` });
let aS = {
  success(a, b, c) {
    j.success(a, b, c);
  },
...
export {
  ...
  L as Col,
  M as Content,
  aN as DEFAULT_TABLE_BORDER_STYLES,
  aA as DateTimePicker,
  aC as Divider,
  aQ as Drawer,
